...
private  void  flatten_polygons(
    ...
    VIO_Real             radius,
    VIO_Real             ratio,
    VIO_BOOL          min_specified,
    VIO_Real             minimum_value,
    VIO_Real             maximum_value,
    int              start_vertex,
